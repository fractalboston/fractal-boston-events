...
const config: Env = {
  ...
  DISCORD_EVENTS_WEBHOOK_URL: env.get('DISCORD_EVENTS_WEBHOOK_URL').required().asUrlString(),
  DISCORD_LOGGING_WEBHOOK_URL: env.get('DISCORD_LOGGING_WEBHOOK_URL').required().asUrlString(),
